  ...
  return (
    <Section id="skills" backgroundColor="#f7f7f7">
      ...
      <div className={styles.cardContainer}>
        <Skill borderColor="#ef476f" title="web制作" experience={true}>
        ...
        <Skill borderColor="#ef476f" title="web開発" experience={false}>
          <div className={styles.skill}>
            <Javascript size={30} style={{ color: '#ef476f', marginRight: '5px' }} />
            Javascript
          </div>
        ...
        <Skill borderColor="#ef476f" title="salesforce開発" experience={true}>
          <div className={styles.skill}>
